...
public class TelaInicial2 extends javax.swing.JFrame {
    ...
    static Integer botaoEscolhido = 0;
    public TelaInicial2() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Escolha a tela que deseja abrir:");
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(-20, 0, 180, 80));
        ...
        jRadioButton1.setText("Tela de Monitoramento");
        jPanel1.add(jRadioButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 410, -1, -1));

        buttonGroup1.add(jRadioButton2);
        jRadioButton2.setText("Tela do Metrô");
        jPanel1.add(jRadioButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 410, -1, -1));

        jLabel10.setFont(new java.awt.Font("Dubai", 1, 14)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(111, 44, 145));
        jLabel10.setText("Código da Maquina");
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        // Se o botão da Tela de Metro estiver clicado
        ...
        java.awt.EventQueue.invokeLater(new Runnable() 
        {
            ...
            public void loopEntrar() 
            {
                while (true) 
                {
                    ...
                    {
                        TelaRPA2 telarpa = new TelaRPA2(telaLogin.getIdMaquina());
                        telarpa.setVisible(true);
                        telaLogin.setVisible(false);
                        while (true) 
                        {
                            if (TelaRPA2.isStatusMonitoramento() == false) 
                            {
