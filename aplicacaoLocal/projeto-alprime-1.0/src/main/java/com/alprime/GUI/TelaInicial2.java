...
public class TelaInicial2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblErroSenha.setForeground(new java.awt.Color(111, 44, 145));
        ...
        lblErroCodigo.setForeground(new java.awt.Color(111, 44, 145));
        ...
        if (idMaquina > 0) {
            ...
            try {
                ...
                if (maquina.getSenhaMaquina().equals(txtSenha.getText())) {
                    System.out.println("Abrindo tela de monitoramento");
                    TelaMonitoramento2 tela = new TelaMonitoramento2(idMaquina);
